...
$(document).ready(function () {
	...
	var options = [
			{ 	// word 3
				size : 330,
				weight : 12,
				color: ['#c3df60','#6FC3C0','#8F5699','#EB6A66', '#F4BF26','#c3df60','#6FC3C0','#8BC34A','#8F5699','#EB6A66', '#F4BF26','#c3df60','#6FC3C0','#8BC34A','#8F5699','#EB6A66', '#F4BF26' ],
				duration: 0.5,
				fade: 0,
				delay: 0.2,
		...
		items.forEach(function(item, pos) {
			...
			playCtrl.addEventListener('click', function() {
				...
				// showcase with animations using mo.js lib:
					...
					instance.hide({
						duration: 0.8, delay: 0.1, easing: d3_ease.easeExpOut.ease,
						callback: function() {
							timelines[pos+1].start();
							instance.show({callback : endPlayCallback});
						}
